...
export default function CreateStoreForm({ onSuccess }: CreateStoreFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!result.success) throw new Error(result.error || 'Failed to create store');
  ...
  return (
    <div className="w-full max-w-md mx-auto p-6 bg-white rounded-lg shadow-md">
      <h2 className="text-2xl font-bold text-center mb-6">Create Your Magical Shop</h2>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-6">
          ...
          <p className="text-xs text-gray-500 mt-1">
            Leave blank to automatically generate from your shop name
          </p>
